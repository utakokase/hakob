...
const ja: Translations = {
  ...
  form: {
    ...
    buildingType: "物件タイプ",
    buildingTypes: { mansion: "マンション・アパート", apartment: "マンション・アパート", house: "一軒家" },
    moveIn: "入居希望時期",
...
const en: Translations = {
  ...
  form: {
    ...
    buildingTypes: { mansion: "Apartment / Mansion", apartment: "Apartment / Mansion", house: "House" },
...
const zh: Translations = {
  ...
  form: {
    ...
    namePlaceholder: "例：田中 太郎",
    buildingType: "房源类型",
    buildingTypes: { mansion: "公寓 / Mansion", apartment: "公寓 / Mansion", house: "独栋住宅" },
    moveIn: "希望入住时间",
